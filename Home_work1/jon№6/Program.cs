...
// end мы присвои значение с которым будем сравнивать input
...
while(input?.ToLower() != end){
    ...
    do{
        ...
        try{
            ...
            break;
        // если попытка записать число не удалась, у нас возникает ошибка ввода (прям во всех случаях ввода чего-от, отличного от целого числа со знаком)
    ...
    // здесь зацикленный while, т.е. while(true) - бесконечный чикл.
